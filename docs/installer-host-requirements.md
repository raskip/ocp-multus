...
see [`docs/network-prereqs.md` section 4a](./network-prereqs.md#4a-least-privilege-azure-rbac-for-byo-network-mode)
for the minimum subnet and route-table rights. No VNet Contributor is
required if subnets, NSGs, and UDR associations are pre-provisioned.
